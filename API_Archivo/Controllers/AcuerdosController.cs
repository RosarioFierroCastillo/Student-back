            ...
            using (MySqlConnection conexion = new MySqlConnection(Global.cadena_conexion))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Lista_acuerdos.Add(new freepbx() { fecha = reader.GetString(0), origen = reader.GetString(1), destino = reader.GetString(2), duracion = reader.GetString(3), estatus = reader.GetString(4) });
                    }
